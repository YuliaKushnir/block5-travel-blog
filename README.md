...
https://github.com/YuliaKushnir/block2-travel-blog
При створенні нового допису block2-travel-blog формує email-повідомлення і відправляє в чергу.
block5-travel-blog зчитує це повідомлення з черги за допомогою RabbitListener, зберігає його в Elasticsearch і надсилає його на вказані в повідомленні email адреси користувачів з використанням JavaMailSender. 
Якщо відбулась помилка при надсиланні - статус змінюється на ERROR і здійснюється ще 4 спроби для надсилання цього email через кожні 5 хвилин (@Scheduled). Після всіх використаних спроб при невдалому надсиланні статус змінюється на FAILED.
Статуси повідомлень можна переглянути в Kibana.
